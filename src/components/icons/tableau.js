...
const IconTableau = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor" // use currentColor for better styling via CSS
    width={props.width || "800px"}
    height={props.height || "800px"}
    viewBox="0 0 32 32"
    {...props} // spread all other props like `style`, `className`, `onClick`, etc.
  >
    <title>Tableau Icon</title>
